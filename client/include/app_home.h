...
typedef enum HomeCommand {
    ...
    HOME_COMMAND_PICTURE = 5,
    HOME_COMMAND_RESET = 6,
    HOME_COMMAND_CLEAR = 7,
    HOME_COMMAND_COMPRESS = 8,
    HOME_COMMAND_HELP = 9,
    HOME_COMMAND_STATUS = 10,
    HOME_COMMAND_COMMANDS = 11,
    HOME_COMMAND_PROVIDER = 12,
    HOME_COMMAND_ROLLBACK = 13,
    HOME_COMMAND_REASONING = 14,
    HOME_COMMAND_FAST = 15,
    HOME_COMMAND_MODEL = 16,
    HOME_COMMAND_PERSONALITY = 17,
    HOME_COMMAND_RESUME = 18,
} HomeCommand;
